          ...
          <div class="border-top pt-4" style="border-color: #1d1d1d !important">
            <div class="row">
              ...
              <div class="col-lg-6 text-lg-right">
                <p class="small text-muted mb-0">Template designed by <a class="text-white reset-anchor" href="https://bootstraptemple.com/p/bootstrap-ecommerce">Bootstrap Temple</a> and Powered by <a href="https://laravel.com">Laravel</a> written by <a href="https://zubs.github.io">Zubair</a> with <i class="fas fa-heart" style="color: red;"></i></p>
              </div>
            </div>
          </div>
        </div>
