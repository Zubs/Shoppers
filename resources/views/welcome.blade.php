...
@section('content')
    <div class="site-blocks-cover" style="background-image: url('{{ asset('template/images/hero_1.jpg') }}');" data-aos="fade">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="{{ asset('template/images/blog_1.jpg') }}" alt="Image placeholder" class="img-fluid rounded"></a>
          </div>
