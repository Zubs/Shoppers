          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='{{ route('wishlist.allToCart') }}'" {{ Cart::instance('wishlist')->count() ? "" : "disabled" }}>Move All To Cart</button>
                  </div>
                </div>
              </div>
            </div>
