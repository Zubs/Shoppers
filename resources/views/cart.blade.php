            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-0">
                          <div class="border d-flex align-items-center justify-content-between px-3"><span class="small text-uppercase text-gray headings-font-family">Quantity</span>
                            <div class="quantity">
                              <input id="item-quantity-{{ $product->id }}" class="form-control form-control-sm border-0 shadow-0 p-0 item-quantity" disabled type="text" value="{{ $product->quantity }}"/>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle border-0">
                    ...
                    @empty
                      <tr class="text-center">
                        <th colspan="4">No Items In Cart</th>
                      </tr>
                    @endforelse
                  </tbody>
                </table>
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  ...
                  <div class="col-md-6 text-md-right"><a class="btn btn-outline-dark btn-sm {{ Cart::getContent()->count() == 0 ? "disabled" : "" }}" href="{{ route('checkout.index') }}">Procceed to checkout<i class="fas fa-long-arrow-alt-right ml-2"></i></a></div>
                </div>
              </div>
            </div>
            <!-- ORDER TOTAL-->
